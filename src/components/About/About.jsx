...
export default function About() {
  ...
  return (
    <div style={{ padding: 0, top: 100 }} className={classes.roott}>
      <Grid container className={classes.root} spacing={3}>
        <Grid item xs={12} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: 0 }}>
          <AboutContent />
        </Grid>
        <Grid item xs={12} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: 0 }}>
          <Typography style={{ color: "#ffffff", fontWeight: '900', textAlign: 'center' }} variant="h5" > International University - Dormitory Management Center</Typography>
        </Grid>
        <Grid item xs={12} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <Typography style={{ color: "#ffffff", fontWeight: 'bold', textAlign: 'center' }} variant="h6" > IU Dormitory</Typography>
        </Grid>
        <Divider light />
        <Grid item xs={12} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <Content />
