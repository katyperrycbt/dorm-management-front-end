...
import { activateAccount } from '../../../actions/admin.stuff';
...
export default function AlertDialog({ studentId, roomId }) {
    ...
    const handleDeactivate = () => {
        ...
        if (studentId && roomId) {
            ...
            activateAccount({ _id: roomId, student: studentId }).then((rs) => {
        ...
        <div>
            ...
            >
                <Typography align="center" variant="h4" style={{ color: '#ff3d00', margin: '10px 15px 5px 15px' }}>
                    You confirm that you are about to open this account.
                </Typography>
                <DialogContent>
                    <Typography style={{ color: '#00695f' }}>
                        After re-open the account, you need to re-arrangement room for student.
                    </Typography>
                </DialogContent>
                <DialogActions>
