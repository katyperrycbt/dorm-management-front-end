...
const ChangeRoom = () => {
    ...
    return (<Grid container spacing={3} >
        ...
        <Grid item xs={12} sm={6} md={6} lg={4}>
            <Typography align="center" variant="h4" style={{ color: '#f50057' }}>Activate Account</Typography>
            <div style={{ width: '100%', position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                <ConfirmActivate studentId={currentStudent._id} roomId={currentStudent.current}/>
            </div>
        </Grid>
    </Grid>)
}
