...
export default function SwipeableTemporaryDrawer({ sideMenu, setSideMenu }) {
    ...
    const list = (anchor) => (
        ...
        >
            ...
            <Divider />
            <List>
                {['Home page', 'Personal information', 'Resident information', 'Bills', 'Request', 'Notifications', 'Log out'].map((text, index) => (
                ...
                <HtmlTooltip
                    title={
                        <React.Fragment>
                            ...
                            {'This website is owned by team PASS (International University), designed by a team called'} <b>KATYPERRYCBT</b>
                        </React.Fragment>
                    }
                >
                    <Typography variant="body1">Copyright &copy; 2021 Team PASS of the International University Ho Chi Minh City. All rights reserved.</Typography>
                </HtmlTooltip>
            </List>
        </div>
    );
